...
export class AuthService {
    ...
    resendOTP(phone: string): Observable<any> {
        return this._httpClient.post('https://formero-api.knic.au/api/v1/auth/user/otp', { phone: phone });
    }
    ...
    signOut(): Observable<any> {
        ...
        // return of(true);
        return this._httpClient.get(this.apiUrl + 'auth/logout', {headers : new HttpHeaders({
            'Accept-Version': 'v1'
          })})
    }
